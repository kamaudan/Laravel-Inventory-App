...
<div class="well" align="center">
    ...
    {!!Form::open(['action' => 'ShopmController@store', 'method' => 'POST'])!!}
    ...
    <div class="form-group">
        {{ Form::label('ocash ', 'Opening Cash') }}
        {{Form::text('ocash', '',['class' => 'form-control','placeholder'=> 'Enter Opening Cash'])}}
    </div>
    <div class="form-group">
        {{ Form::label('ofloat', 'Opening Float') }}
        {{Form::text('ofloat', '',['class' => 'form-control','placeholder'=> 'Enter Opening Flaot'])}}
    </div>
